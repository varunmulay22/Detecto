[Detecto](https://detecto.herokuapp.com/) is a fun website based primarily on face detection principles and a machine learning API  Clarifai which detects faces on an user provided image URL
